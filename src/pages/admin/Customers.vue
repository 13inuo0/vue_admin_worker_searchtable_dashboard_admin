<template>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex-1/2 w-full bg-white dark:bg-gray-700 rounded-lg p-4">
              ...
              <div class="grid grid-col-2 gap-4 pb-2">
                <div
  ...
  <!-- 삭제 확인 모달 -->
  <div v-if="showDelModal" class="modal fixed inset-0 bg-black/80 bg-opacity-75 flex items-center justify-center p-4">
